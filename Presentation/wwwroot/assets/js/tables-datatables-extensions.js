$(function () {
    ...
    e.length &&
        ...
        ((e = a.DataTable({
                ...
                { targets: 2, visible: !1 },
                {
                    ...
                    render: function (e, a, t, s) {
                        ...
                        return (
                            ...
                            (l
                                ? '<img src="' + assetsPath + "img/avatars/" + l + '" alt="Avatar" class="rounded-circle">'
                                : '<span class="avatar-initial rounded-circle bg-label-' +
                                ["success", "danger", "warning", "info", "dark", "primary", "secondary"][Math.floor(6 * Math.random())] +
                                '">' +
                                (l = (((l = (r = t.full_name).match(/\b\w/g) || []).shift() || "") + (l.pop() || "")).toUpperCase()) +
                                "</span>") +
            ...
            window.Helpers.isNavbarFixed() ? ((a = $("#layout-navbar").outerHeight()), new $.fn.dataTable.FixedHeader(e).headerOffset(a)) : new $.fn.dataTable.FixedHeader(e)),
        t.length &&
        t.DataTable({
            ajax: assetsPath + "json/table-datatable.json",
            columns: [{ data: "full_name" }, { data: "post" }, { data: "email" }, { data: "city" }, { data: "start_date" }, { data: "salary" }, { data: "age" }, { data: "experience" }, { data: "status" }, { data: "id" }],
            columnDefs: [
                {
                    targets: -2,
                    render: function (e, a, t, s) {
