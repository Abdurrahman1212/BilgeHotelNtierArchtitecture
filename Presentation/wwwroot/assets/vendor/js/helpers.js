                    ...
                    e.forEach(function (e) {
                        e.addEventListener("click", function (t) {
                            ...
                            "text" === o.getAttribute("type")
                                ? (o.setAttribute("type", "password"), i.classList.replace("ri-eye-line", "ri-eye-off-line"))
                                : "password" === o.getAttribute("type") && (o.setAttribute("type", "text"), i.classList.replace("ri-eye-off-line", "ri-eye-line"));
                        });
                    });
            },
